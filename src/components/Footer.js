...
import FullLogo from '../assets/sid_logo_text.svg';
...
const socials = {
    ...
    instagram: 'https://www.instagram.com/_sid_v/'
};
        ...
        <FooterContainer initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
            <SocialsContainer>
                ...
                <SocialContainer>
                    ...
                    <Icon onClick={() => open(socials.instagram)}><FontAwesomeIcon icon={faInstagram} size="lg" /></Icon>
                </SocialContainer>
            </SocialsContainer>
        </FooterContainer>
    );
